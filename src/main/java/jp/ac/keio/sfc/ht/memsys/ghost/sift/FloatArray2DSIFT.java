...
public class FloatArray2DSIFT implements Serializable{
     ...
     * @param octave_sigma sigma of the corresponding gaussian kernel with respect to the
     *                     scale octave
     ...
     *
     * @param src           image having a generating gaussian kernel of initial_sigma img
     ...
     * @param max_size      maximal size of an octave to be taken into account Use this to
